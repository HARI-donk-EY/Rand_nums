...
By substituting,
\begin{align*}
F_T(t) & = \int_0^{t-1} 1 \text{ dx} + \int_{t-1}^1 (t-x)\text{ dx}\\
& = t-1 + t - t^2 - t - \frac{1}{2} + \frac{(t-1)^2}{2} \\
& = \frac{-t^2}{2} + 2t - 1
\end{align*}
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{./codes/4/fig/tri_cdf.png}
	\caption{The CDF of $T$}
	\label{fig: tri_cdf}
\end{figure}
\item Find the PDF of $T$.\\

\solution We know that $PDF$ of $T$ can be given as,
\begin{align*}
p_T(t) &= \frac{\text{d}}{\text{dt}} F_T(t)
\end{align*}
Therefore,
\begin{align*}
p_T(t) & =
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{./codes/4/fig/tri_pdf.png}
...
\solution The theoretical expressions for the CDF and PDF are as follws,\\
The CDF is,
\begin{align*}
F_T(t) = 
\begin{cases}
...
\solution Download the following Python codes that plot Fig. \ref{fig: tri_cdf} and Fig. \ref{fig: tri_pdf}
\begin{lstlisting}
wget https://github.com/HARI-donk-EY/Rand_nums/blob/main/codes/4/cdf_plot_tri.py
wget https://github.com/HARI-donk-EY/Rand_nums/blob/main/codes/4/pdf_plot.py
\end{lstlisting}
Run the code by executing
\begin{lstlisting}
